    ...
    constructor(par, fun) {
        ...
        this.init = function (o) {
            ...
            for (var i = 0; i < this.objThree.array.length; i++) {
                this.array[i] = new MLButGal(
                    this,
                    this.drag,
                    i,
                    this.objThree.array[i],
                );
            }
    ...
    constructor(par, fun, idArr, obj) {
        ...
        this.dragParam = function () {
            ...
            if (this.gallery) {
                ...
                this.gallery.width =
                    this.param.wh * 1.5 * 2 + this.gallery.otstup * 2 + 2;
                this.gallery.height =
                    this.param.wh * 1.5 * this.gallery.kolII +
                    2 +
                    this.gallery.otstup * 2 +
                    2;
        ...
        this.init = function (o) {
            ...
            if (this.obj.array.length != 0) {
                ...
                for (var i = 0; i < this.obj.array.length; i++) {
                    ...
                    this.obj.array[i].src =
                        'resources/data/' + this.obj.array[i].id + '/128.png';
                }
                ...
                if (this.obj.array.length == 0) {
                    ...
                    this.gallery.height =
                        Math.ceil(this.obj.array.length / this.gallery.kolII) *
                            66 +
                        2;

                    if (this._startIndex != -1)
                        this.gallery.index = this._startIndex;
                }
            }
        };
    }
