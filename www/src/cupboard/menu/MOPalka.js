...
export class MOPalka extends MOBaza {
  	constructor(par,fun) {  
        super(par,fun);
  		this.type="MOPalka";
        this.typeNa="CPalka";
        ...
        this.postSO=function(){ 
           ...
           trace()
            ...
            this.window.height=this.pObject.height+32+this.otstup
            this.window.title=this.typeNa+" : "+this.object.idArr//+" : "+ this.object.uuid;
            this.drag()
        }
        this.clear=function(){
